...
/*                                                                                                   \
      CLASSIFICATION BASED ON                                                                        / 
            1. ROUGH SET THEORY & 2. GENETIC ALGORITHM (BOTH)                                        \ 
      PERFORMANCE ANALYSIS                                                                           /  
            ONLY ROUGH SET  VS  ROUGH SET+GENETIC CLASSIFICATION                                     \  
/****************************************************************************************************/
/****************************************************************************************************/
/*                                                                                                   \    
...
#include "compare.cpp"
// "h_cross_mod.cpp" used for 10_fold cross validation testing
//////////////////////////////////////////////////////////////
vector<dd> acc_rs;
vector<dd> acc_gen;
/////////////////////////  INTEGER(ll)_TO STRING  ///////////////////////////
...
int main(){
  ...
  cout<<"Enter the name of data file ( without .data ):";
  cin>>file_org;
  FILE *p1=fopen("rules_RS.txt","w");
  FILE *p2=fopen("rules_GENETIC.txt","w"); 
  system("g++ h_cross_rs_genetic.cpp");    // For 10_fold cross validation testing
  ...
  cout<<"Average efficiency in RS="<<rs_acc<<endl;
  cout<<"Average efficiency in GENETIC="<<gen_acc<<endl;
